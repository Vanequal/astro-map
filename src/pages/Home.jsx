          ...
          <div className="about-section__cards">
            <div className="about-section__card">
              <div className="about-section__card-icon">
                <img src="/src/assets/images/sun-card.svg" alt="Work" />
              </div>
            ...
            <div className="about-section__card">
              <div className="about-section__card-icon">
                <img src="/src/assets/images/love-card.svg" alt="Love" />
              </div>
            ...
            <div className="about-section__card">
              <div className="about-section__card-icon">
                <img src="/src/assets/images/health-card.svg" alt="Health" />
              </div>
            ...
            <div className="about-section__card">
              <div className="about-section__card-icon">
                <img src="/src/assets/images/life-card.svg" alt="Life" />
              </div>
        ...
        <div className="container">
          ...
          <div className="question-section__block">
            <div className="question-section__content">
              ...
              <div className="question-section__right">
                <img src="/src/assets/images/profesional.png" alt="Professional" />
              </div>
            </div>
          </div>
          ...
          <div className="question-section__block">
            <div className="question-section__content">
              ...
              <div className="question-section__right">
                <img src="/src/assets/images/partner.png" alt="Partner" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="course-section__modules">
            <div className="course-section__module">
              <div className="course-section__module-icon">
                <img src="/src/assets/images/module-1.svg" alt="Module 1" />
              </div>
            ...
            <div className="course-section__module">
              <div className="course-section__module-icon">
                <img src="/src/assets/images/module-2.svg" alt="Module 2" />
              </div>
              <h4 className="course-section__module-title heading">
                Модуль 2.<br />
            ...
            <div className="course-section__module">
              <div className="course-section__module-icon">
                <img src="/src/assets/images/module-3.svg" alt="Module 3" />
              </div>
              <h4 className="course-section__module-title heading">
                Модуль 3.<br />
                Знаки Зодиака
            ...
            <div className="course-section__module">
              <div className="course-section__module-icon">
                <img src="/src/assets/images/module-4.svg" alt="Module 4" />
              </div>
              <h4 className="course-section__module-title heading">
                Модуль 4.<br />
                Астрологические<br />
            ...
            <div className="course-section__module">
              <div className="course-section__module-icon">
                <img src="/src/assets/images/module-5.svg" alt="Module 5" />
              </div>
              <h4 className="course-section__module-title heading">
                Модуль 5.<br />
                Аспекты между<br />
            ...
            <div className="course-section__module">
              <div className="course-section__module-icon">
                <img src="/src/assets/images/module-6.svg" alt="Module 6" />
              </div>
              <h4 className="course-section__module-title heading">
                Модуль 6.<br />
